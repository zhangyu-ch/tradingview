const TradingView = ((e) => {
  ...
  function Fe(e, t) {
    const i = { ...e };
    for (const o in t) {
      if (typeof e[o] != "object" || e[o] === null || Array.isArray(e[o])) {
        if (t[o] !== undefined) {
          i[o] = t[o];
        }
      } else {
  ...
  e.ActionId = undefined;
  t = e.ActionId || (e.ActionId = {});
  ...
  t.ChartDialogsShowNews = "Chart.Dialogs.ShowNews";
  ...
  t.ChartDialogsShowForwardCurve = "Chart.Dialogs.ShowForwardCurve";
  t.ChartDialogsShowInsertDocuments = "Chart.Dialogs.ShowInsertDocuments";
  t.ChartDialogsShowInsertEtfs = "Chart.Dialogs.ShowInsertEtfs";
  t.ChartDialogsShowInsertContracts = "Chart.Dialogs.ShowInsertContracts";
  ...
  t.ChartLegendToggleBarChangeColor = "Chart.Legend.ToggleBarChangeColor";
  ...
  t.ChartSelectedObjectInsertRowTable = "Chart.SelectedObject.InsertRowTable";
  t.ChartSelectedObjectInsertColumnTable =
    "Chart.SelectedObject.InsertColumnTable";
  t.ChartSelectedObjectRemoveRowTable = "Chart.SelectedObject.RemoveRowTable";
  ...
  t.ChartSelectedObjectToggleAnchored = "Chart.SelectedObject.ToggleAnchored";
  ...
  t.ChartToggleVisibilityKeyFactsToday = "Chart.ToggleVisibility.KeyFactsToday";
  ...
  e.TimeFrameType = undefined;
  r = e.TimeFrameType || (e.TimeFrameType = {});
  r.PeriodBack = "period-back";
  ...
  e.MarketStatus = undefined;
  a = e.MarketStatus || (e.MarketStatus = {});
  a.Open = "market";
  a.Pre = "pre_market";
  a.Post = "post_market";
  a.Close = "out_of_session";
  a.Holiday = "holiday";
  e.MenuItemType = undefined;
  s = e.MenuItemType || (e.MenuItemType = {});
  s.Separator = "separator";
  s.Action = "action";
  e.ClearMarksMode = undefined;
  l = e.ClearMarksMode || (e.ClearMarksMode = {});
  l[(l.All = 0)] = "All";
  l[(l.BarMarks = 1)] = "BarMarks";
  l[(l.TimeScaleMarks = 2)] = "TimeScaleMarks";
  e.LineStudyPlotStyle = undefined;
  d = e.LineStudyPlotStyle || (e.LineStudyPlotStyle = {});
  d[(d.Line = 0)] = "Line";
  ...
  e.StudyPlotType = undefined;
  c = e.StudyPlotType || (e.StudyPlotType = {});
  c.Line = "line";
  c.Colorer = "colorer";
  ...
  e.StudyPlotDisplayTarget = undefined;
  ...
  g[(g.PineScreener = 16)] = "PineScreener";
  g[(g.All = 4294967295)] = "All";
  ...
  ((e) => {
    ...
    e[(e.PineScreener = 16)] = "PineScreener";
    e[(e.All = 4294967295)] = "All";
  })(u || (u = {}));

  e.OhlcStudyPlotStyle = undefined;
  C = e.OhlcStudyPlotStyle || (e.OhlcStudyPlotStyle = {});
  C.OhlcBars = "ohlc_bars";
  ...
  e.StudyInputType = undefined;
  p = e.StudyInputType || (e.StudyInputType = {});
  p.Integer = "integer";
  p.Float = "float";
  p.Price = "price";
  p.Bool = "bool";
  ...
  e.StudyTargetPriceScale = undefined;
  w = e.StudyTargetPriceScale || (e.StudyTargetPriceScale = {});
  w[(w.Right = 0)] = "Right";
  w[(w.Left = 1)] = "Left";
  w[(w.NoScale = 2)] = "NoScale";
  ...
  e.FilledAreaType = undefined;
  f = e.FilledAreaType || (e.FilledAreaType = {});
  f.TypePlots = "plot_plot";
  f.TypeHlines = "hline_hline";
  ...
  e.ConnectionStatus = undefined;
  W = e.ConnectionStatus || (e.ConnectionStatus = {});
  W[(W.Connected = 1)] = "Connected";
  ...
  e.OrderType = undefined;
  M = e.OrderType || (e.OrderType = {});
  M[(M.Limit = 1)] = "Limit";
  M[(M.Market = 2)] = "Market";
  M[(M.Stop = 3)] = "Stop";
  ...
  e.OrderStatusFilter = undefined;
  j = e.OrderStatusFilter || (e.OrderStatusFilter = {});
  j[(j.All = 0)] = "All";
  ...
  e.ParentType = undefined;
  $ = e.ParentType || (e.ParentType = {});
  $[($.Order = 1)] = "Order";
  $[($.Position = 2)] = "Position";
  ...
  e.OrderTicketFocusControl = undefined;
  q = e.OrderTicketFocusControl || (e.OrderTicketFocusControl = {});
  q[(q.LimitPrice = 1)] = "LimitPrice";
  ...
  Q = e.NotificationType || (e.NotificationType = {});
  Q[(Q.Error = 0)] = "Error";
  ...
  e.OrderOrPositionMessageType = undefined;

  X = e.OrderOrPositionMessageType || (e.OrderOrPositionMessageType = {});
  ...
  ((e) => {
    ...
    e[(e.SwitchBroker = 11)] = "SwitchBroker";
  })(te || (te = {}));
  ...
  ((e) => {
    e.TakeProfit = "take_profit";
    e.ExitLevels = "exit_levels";
  })(se || (se = {}));

  e.StandardFormatterName = undefined;
  le = e.StandardFormatterName || (e.StandardFormatterName = {});
  le.Date = "date";
  le.DateOrDateTime = "dateOrDateTime";
  le.Default = "default";
  le.Fixed = "fixed";
  le.FixedInCurrency = "fixedInCurrency";
  le.VariablePrecision = "variablePrecision";
  le.FormatQuantity = "formatQuantity";
  le.FormatPrice = "formatPrice";
  le.FormatPriceForexSup = "formatPriceForexSup";
  le.FormatExitLevels = "formatExitLevels";
  le.FormatPriceInCurrency = "formatPriceInCurrency";
  le.IntegerSeparated = "integerSeparated";
  le.LocalDate = "localDate";
  le.LocalDateOrDateTime = "localDateOrDateTime";
  le.Percentage = "percentage";
  le.Pips = "pips";
  le.Profit = "profit";
  le.ProfitInInstrumentCurrency = "profitInInstrumentCurrency";
  le.ProfitInPercent = "profitInPercent";
  le.Side = "side";
  le.PositionSide = "positionSide";
  le.Status = "status";
  le.Symbol = "symbol";
  le.Text = "text";
  le.Type = "type";
  le.MarginPercent = "marginPercent";
  le.Empty = "empty";
  e.OverridePriceAxisLastValueMode = undefined;

  de =
    e.OverridePriceAxisLastValueMode || (e.OverridePriceAxisLastValueMode = {});

  de[(de.LastPriceAndPercentageValue = 0)] = "LastPriceAndPercentageValue";
  de[(de.LastValueAccordingToScale = 1)] = "LastValueAccordingToScale";
  e.OverrideLineStyle = undefined;
  ce = e.OverrideLineStyle || (e.OverrideLineStyle = {});
  ce[(ce.Solid = 0)] = "Solid";
  ce[(ce.Dotted = 1)] = "Dotted";
  ce[(ce.Dashed = 2)] = "Dashed";
  ...
  e.ChartStyle = undefined;
  ue = e.ChartStyle || (e.ChartStyle = {});
  ue[(ue.Bar = 0)] = "Bar";
  ue[(ue.Candle = 1)] = "Candle";
  ue[(ue.Line = 2)] = "Line";
  ue[(ue.Area = 3)] = "Area";
  ue[(ue.Renko = 4)] = "Renko";
  ue[(ue.Kagi = 5)] = "Kagi";
  ue[(ue.PnF = 6)] = "PnF";
  ue[(ue.LineBreak = 7)] = "LineBreak";
  ue[(ue.HeikinAshi = 8)] = "HeikinAshi";
  ue[(ue.HollowCandle = 9)] = "HollowCandle";
  ue[(ue.Baseline = 10)] = "Baseline";
  ue[(ue.Range = 11)] = "Range";
  ue[(ue.HiLo = 12)] = "HiLo";
  ue[(ue.Column = 13)] = "Column";
  ue[(ue.LineWithMarkers = 14)] = "LineWithMarkers";
  ue[(ue.Stepline = 15)] = "Stepline";
  ue[(ue.HLCArea = 16)] = "HLCArea";
  ue[(ue.VolFootprint = 17)] = "VolFootprint";
  ue[(ue.TPO = 18)] = "TPO";
  ue[(ue.VolCandle = 19)] = "VolCandle";
  ue[(ue.SVP = 20)] = "SVP";
  ue[(ue.HLCBars = 21)] = "HLCBars";
  e.TimeHoursFormat = undefined;
  Ce = e.TimeHoursFormat || (e.TimeHoursFormat = {});
  Ce.TwentyFourHours = "24-hours";
  ...
  e.PlDisplay = undefined;
  pe = e.PlDisplay || (e.PlDisplay = {});
  pe[(pe.Money = 0)] = "Money";
  pe[(pe.Pips = 1)] = "Pips";
  pe[(pe.Percentage = 2)] = "Percentage";
  e.TradedGroupHorizontalAlignment = undefined;

  me =
    e.TradedGroupHorizontalAlignment || (e.TradedGroupHorizontalAlignment = {});

  me[(me.Left = 0)] = "Left";
  me[(me.Center = 1)] = "Center";
  me[(me.Right = 2)] = "Right";
  e.PlDisplay.Money;
  e.PlDisplay.Money;
  ...
  e.VisibilityType = undefined;
  Pe = e.VisibilityType || (e.VisibilityType = {});
  Pe.AlwaysOn = "alwaysOn";
  Pe.VisibleOnMouseOver = "visibleOnMouseOver";
  Pe.AlwaysOff = "alwaysOff";
  e.PriceScaleMode = undefined;
  we = e.PriceScaleMode || (e.PriceScaleMode = {});
  we[(we.Normal = 0)] = "Normal";
  we[(we.Log = 1)] = "Log";
  we[(we.Percentage = 2)] = "Percentage";
  we[(we.IndexedTo100 = 3)] = "IndexedTo100";
  e.SeriesType = undefined;
  Le = e.SeriesType || (e.SeriesType = {});
  Le[(Le.Bars = 0)] = "Bars";
  ...
  e.HHistDirection = undefined;
  ve = e.HHistDirection || (e.HHistDirection = {});
  ve.LeftToRight = "left_to_right";
  ve.RightToLeft = "right_to_left";
  ...
  e.MarkLocation = undefined;
  Re = e.MarkLocation || (e.MarkLocation = {});
  Re.AboveBar = "AboveBar";
  Re.BelowBar = "BelowBar";
  Re.Top = "Top";
  Re.Bottom = "Bottom";
  Re.Right = "Right";
  Re.Left = "Left";
  Re.Absolute = "Absolute";
  Re.AbsoluteUp = "AbsoluteUp";
  Re.AbsoluteDown = "AbsoluteDown";
  ...
  Ve = e.LineStyle || (e.LineStyle = {});
  Ve[(Ve.Solid = 0)] = "Solid";
  Ve[(Ve.Dotted = 1)] = "Dotted";
  Ve[(Ve.Dashed = 2)] = "Dashed";
  ...
  function Be() {
    return "CL v31.0.0 (internal id 028f81fbf6fef55e9694e5df4bd5106cc04c188a @ 2026-03-05T20:44:53.566Z)";
  }
  const Ne = class {
    constructor(e) {
      ...
      if (e.overrides?.["mainSeriesProperties.priceAxisProperties.lockScale"]) {
        console.warn(
      ...
      this._options = Fe(We, e);

      if (
        (this._options.theme || "light").toLowerCase() === "dark" &&
        this._options.loading_screen === undefined
      ) {
        this._options.loading_screen = { backgroundColor: "#131722" };
      }

      if (this._options.debug || this._options.debug_broker) {
        if (!Me) {
          Me = true;

          console.log(
            "Using CL v31.0.0 (internal id 028f81fbf6fef55e9694e5df4bd5106cc04c188a @ 2026-03-05T20:44:53.566Z)"
          );
        }
      }
    ...
    async _create() {
      ...
      a.innerHTML = o;
      this._iFrame = a.querySelector(`#${this._id}`);
      const s = this._iFrame;

      if (e) {
        await this._innerWindowEvent("sameOriginLoad");
      }
    ...
    _generateCustomIconsCSS() {
      if (
        !this._options.custom_icons ||
        this._options.custom_icons.length === 0
      ) {
        return "";
      }
      const e = [];
      for (const t of this._options.custom_icons) {
        const t_name = t.name;
        const o = !!t.useCurrentColor;

        const r = (e) => {
          const t = e.trim().startsWith("<");
          const i = e.startsWith("data:");
          if (
            e.startsWith("http://") ||
            e.startsWith("https://") ||
            e.startsWith("/") ||
          ...
          if (!t) {
            ...
            return new URL(e, i.href).href;
          }
          return `data:image/svg+xml;utf8,${e
            .replace(/"/g, "'")
            .replace(/'/g, "%27")
            .replace(/#/g, "%23")
            .replace(/</g, "%3C")
        ...
        if (o) {
          ...
          if (t.iconDark) {
            const o = r(t.iconDark);
            e.push(
              `html[data-theme="dark"] .lib-icon--${t_name} {\n\t\t\t\t\t\t--icon-url: url('${o}') !important;\n\t\t\t\t\t}`
            );
          }
        }
      }
    ...
    _applyCustomIcons() {
      ...
      const e = this._generateCustomIconsCSS();

      if (e) {
        this._doWhenInnerWindowLoaded((t) => {
          t.addCustomIconsCSS(e);
        });
      }
    }
    _innerWindowEvent(e) {
    ...
    _render(e, t, i) {
      ...
      if (this._options.saved_data) {
        window[this._id].chartContent = { json: this._options.saved_data };

        if (this._options.saved_data_meta_info) {
          window[this._id].chartContentExtendedData =
      ...
      if (this._options.locale) {
        ...
        if (Ee.findIndex((t) => t.language === e) < 0) {
          console.warn("locale isn't supported. Using default of `en`.");
          this._options.locale = "en";
        }
      }

      const r = (this._options.theme || "light").toLowerCase();

      const n = ((e, t, i) => {
        const o = new URL(`${e || ""}`, location.href).href;

        const r = JSON.parse(
          '["bundles/runtime.1d04bf6efb0933523590.js","bundles/__LANG__.500.40eab369dd334e9c974e.js","bundles/2116.700159b1d79897f33385.css","bundles/8224.a47a4a1d886aaa664d1e.js","bundles/library.257d05210b16f5ddbfc2.js"]'
        );

        const n = encodeURIComponent(t);
        const a = i.toLowerCase() !== "light" ? "dark" : "light";

        const s = Ee.find((e) => e.language === n) ?? { iso: "en", dir: "ltr" };

        const l = `lang="${s.iso}" dir="${s.dir}" data-theme="${a}" class="theme-${a}"`;
      ...
      const s = `symbol=${encodeURIComponent(
        ...
        this._options.debug_broker
          ? `&debugBroker=${encodeURIComponent(
              String(this._options.debug_broker)
            )}`
          : ""
      }${
      ...
      return [
        `<iframe\n\t\tversion="CL v31.0.0 (internal id 028f81fbf6fef55e9694e5df4bd5106cc04c188a @ 2026-03-05T20:44:53.566Z)" id="${
          this._id
        }" name="${this._id}" src="${a.href}" data-widget-options="${s}"\n\t\t${
