...
项目中支持的交易市场，在 `src/tradingview_zy/exchange` 目录，新增 自己的交易市场（数据源）；
...
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_baostock.py`
...
* 数据源：通达信
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_tdx.py`
...
* 数据源：MiniQMT
* 交易：支持
* 文件：`src/tradingview_zy/exchange/exchange_qmt.py`

需要券商开通权限；

文档：http://dict.thinktrader.net/nativeApi/start_now.html

使用前提：下载 xtquant，解压后， 并放入 tradingview_zy/src 目录下，并打开 QMT交易端（极简模式）
...
* 数据源：通达信
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_tdx_futures.py`
...
* 数据源：通达信
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_tdx_ny_futures.py`
...
* 数据源：通达信
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_tdx_hk.py`
...
* 数据源：通达信
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_tdx_us.py`
...
* 数据源：通达信
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_tdx_fx.py`
...
* 数据源：富途
* 交易：支持港股交易
* 文件：`src/tradingview_zy/exchange/exchange_futu.py`
...
* 数据源：天勤
* 交易：支持期货交易
* 文件：`src/tradingview_zy/exchange/exchange_tq.py`
...
* 数据源：Polygon
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_polygon.py`
...
* 数据源：Alpaca
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_alpaca.py`
...
* 数据源：盈透证券
* 交易：支持
* 文件：`src/tradingview_zy/exchange/exchange_ib.py`
...
* 数据源：Binance
* 交易：支持 USDT 永续合约
* 文件：`src/tradingview_zy/exchange/exchange_binance.py`
...
* 数据源：ZB
* 交易：支持现货
* 文件：`src/tradingview_zy/exchange/exchange_zb.py`
...
* 数据源：数据库
* 交易：不支持
* 文件：`src/tradingview_zy/exchange/exchange_db.py`
