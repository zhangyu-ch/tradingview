    ...
    def __init__(self):
        ...
        try:
            ...
            all_markets = call_with_bounded_retry(
                ...
                description="exchange_tdx_futures market-map initialization",
            )
            self.market_maps = {}
            for market in all_markets:
                if market["category"] == 3 and market["market"] in [
                    23, 28, 29, 30, 42, 47, 66
                ]:
            ...
            raise ProviderUnavailableError(
                "exchange_tdx_futures initialization failed"
            ) from exc
